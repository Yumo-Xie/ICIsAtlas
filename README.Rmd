...
**ICIsAtlas** is an R package for visualizing and analyzing immune checkpoint inhibitors (ICIs) response data across multiple compiled studies and types of cancers\
...
showDEG Plots meta‑analysis differential expression for a single gene between ICIs responders and non-responders across studies.

showDEP Plots pathway enrichment meta‑analysis results between ICIs responders and non-responders.  
